function[out,err,frames]= PosAnalyser(fconfig,filepath,filenumstart,files,windows,plots,rot_angle,isverbose)
% Modified from PosAnal:
%   * arguments are tidied in fconfig struct
%   * function made more modular
%
...
%parse fconfig
filepath=fconfig.filepath;
file_id=fconfig.file_id;
